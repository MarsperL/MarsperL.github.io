...
<xsl:stylesheet version="3.0" 
    ...
    <xsl:template match="/">
        ...
        <html class="scroll-smooth">
                    ...
                    *,:after,:before{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: ;--tw-contain-size: ;--tw-contain-layout: ;--tw-contain-paint: ;--tw-contain-style: }::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: ;--tw-contain-size: ;--tw-contain-layout: ;--tw-contain-paint: ;--tw-contain-style: }
                    ...
                    .article-card {
                        ...
                        background-image: linear-gradient(var(--card-bg), var(--card-bg)), 
                                          linear-gradient(to right, #4f46e5, #e879f9);
                    ...
                    @media (prefers-color-scheme: light) {
                        .article-card {
                            ...
                            -webkit-backdrop-filter: blur(10px);
							 background-image:linear-gradient(#fff, var(--card-bg)), linear-gradient(to right, rgba(79, 70, 229, 0), rgba(0, 0, 0, 0.1));
                        }
                    }
                    ...
                    .subscribe-card {
                        border: 2px solid transparent;
                        background-image: linear-gradient(#be93c4, rgba(0, 0, 0, 0.06)), linear-gradient(to right, #4f46e5, #e879f9);
                        background-origin: border-box;
                        background-clip: padding-box, border-box;
                    }
                    ...
                    @media (prefers-color-scheme: light) {
                        .subscribe-card {
						    color: #fff;
                            background-image: linear-gradient(rgba(190, 147, 196, 0.7), rgba(0, 0, 0, 0.06)), linear-gradient(to right, #4f46e5, #e879f9);
                        }
                    }
                    ...
                    .article-title a {
                        background: linear-gradient(to right, #4f46e5, #e879f9);
                    ...
                    .article-title a:hover {
                        background: linear-gradient(to right, #49B1F5, #49B1F5);
                        -webkit-background-clip: text;
                        background-clip: text;
                        color: transparent;
                    ...
                    .article-content blockquote {
                        border-left: 4px solid var(--ui-border-color);
                        padding-left: 1rem;
                        margin: 0.5rem 0;
                        font-style: italic;
                    }
            ...
            <body class="min-h-screen min-h-svh font-sans leading-normal antialiased" style="background-color: var(--page-bg);">
             <script src="./js/background.js" ></script>
                <main class="min-w-screen container mx-auto flex min-h-screen max-w-screen-lg flex-col px-4 py-6 md:px-6">
                    ...
                    <header class="space-y-2 pt-2 md:pt-6">
                        ...
                        <!-- 订阅链接卡片 -->
                        <div class="text-body text-sm hidden" id="subscribe-links">
                            <div class="article-card subscribe-card">
                                <h3 class="article-title">订阅此RSS源</h3>
                                <p class="article-content">你可以通过以下方式订阅此RSS源：</p>
                                <div class="flex flex-wrap gap-x-4 gap-y-2 mt-4">
                                    ...
                                    <a class="link intent-neutral variant-animated font-bold" title="RSS Reader" data-href="feed:" data-raw="true" rel="noopener noreferrer">RSS阅读器</a>
                                    <a class="link intent-neutral variant-animated font-bold" title="{$title} 's feed source" data-href="" data-raw="true" rel="noopener noreferrer">查看RSS源</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <xsl:choose>
                                ...
                                <xsl:for-each select="/rss/channel/item">
                                    <article class="article-card">
                                        ...
                                        <div class="article-meta">
                                            <time>
                                                <xsl:choose>
                                                    <xsl:when test="contains(pubDate, 'T')">
                                                        <xsl:value-of select="substring-before(pubDate, 'T')"/>
                                                    </xsl:when>
                            ...
                            <xsl:when test="/atom:feed/atom:entry">
                                <xsl:for-each select="/atom:feed/atom:entry">
                                    <article class="article-card">
                                        <h2 class="article-title">
                                            <a href="{atom:link/@href}" target="_blank" rel="noopener noreferrer">
                                        ...
                                        <div class="article-meta">
                                            <time>
                                                <xsl:choose>
                                                    <xsl:when test="contains(atom:updated, 'T')">
                                                        <xsl:value-of select="substring-before(atom:updated, 'T')"/>
                                                    </xsl:when>
                                                    <xsl:when test="contains(atom:updated, ' ')">
                                                        <xsl:value-of select="substring-before(atom:updated, ' ')"/>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                        ...
                                        <div class="article-content">
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="atom:content">
                                                    <!-- 使用模板处理内容，去除HTML标签 -->
                                                    <xsl:call-template name="strip-html">
                                                        <xsl:with-param name="text" select="atom:content"/>
                                                    </xsl:call-template>
                                                </xsl:when>
                                            </xsl:choose>
                                        </div>
    ...
    <xsl:template name="strip-html">
        ...
        <xsl:choose>
            ...
            <xsl:when test="contains($text, '&lt;')">
                <!-- 获取第一个HTML标签之前的内容 -->
                <xsl:variable name="before-tag" select="substring-before($text, '&lt;')"/>
                <!-- 输出标签之前的内容 -->
                <xsl:value-of select="$before-tag"/>
                <!-- 获取第一个HTML标签 -->
                <xsl:variable name="tag" select="substring-before(substring-after($text, '&lt;'), '&gt;')"/>
                <!-- 获取标签之后的内容 -->
                <xsl:variable name="after-tag" select="substring-after($text, concat('&lt;', $tag, '&gt;'))"/>
                <!-- 递归处理剩余内容 -->
                <xsl:call-template name="strip-html">
                    <xsl:with-param name="text" select="$after-tag"/>
                </xsl:call-template>
            </xsl:when>
            <!-- 如果文本不包含HTML标签，直接输出 -->
            <xsl:otherwise>
